...
import 'package:progresssystem_splashscreen/src/features/authentication/controllers/splash_screen_controller.dart';
        ...
        child: Stack(
          children: [
            ...
            Obx( () => AnimatedPositioned(
              duration: const Duration(milliseconds: 1600),
              top: 80,
              left: splashController.animate.value ? tDefaultSize : -60,
